...
Display()
{
	...
	if (inside)
		gluLookAt(0.f, 0.f, 0.f, 3.f, 0.f, 0.f, 0.f, 1.f, 0.f);
	else
		gluLookAt(3.f, 4.f, 3.f, 0.f, 0.f, 0.f, 0.f, 1.f, 0.f);
	...
	float theta = 30.f * sin((2 * M_PI * Time));
	float theta2 = 30.f * sin((3 * M_PI * Time));
	float z = 0.5 * sin(2 * (2. * M_PI * Time));
	float z2 = 0.5 * sin(3 * (2. * M_PI * Time));
	...
	glTranslatef(0., 0., z2);
	glRotatef(theta2, 0., 0., 1.);
	glRotatef(360.f * Time + 180, 0., 1., 0.);
	glTranslatef(0., 0., 2.);
	glCallList(WireHorseList);
	glPopMatrix();
	...
	glTranslatef(0., 0., z2);
	glRotatef(theta, 0., 0., 1.);
	glRotatef(360.f * Time + 270, 0., 1., 0.);
	glTranslatef(0., 0., 2.);
	glCallList(WireHorseList);
	glPopMatrix();
...
InitLists()
{
	...
	glColor3f(1, 0, 0);
	float dang = 2. * M_PI / (float)(29);
	float ang = 0.;
	glBegin(GL_LINE_LOOP);
	for (int i = 0; i < 30; i++)
	{
		glVertex3f(2 * cos(ang), 0., 2 * sin(ang));
		ang += dang;
	}
	glEnd();
